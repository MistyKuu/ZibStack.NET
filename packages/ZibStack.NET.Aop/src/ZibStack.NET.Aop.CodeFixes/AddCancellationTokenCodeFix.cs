...
/// <summary>
/// Code fix for AOP0015 — appends a defaulted <c>CancellationToken cancellationToken = default</c>
/// parameter to a method that has <c>[Timeout]</c> but no way to observe the cancellation.
/// Using <c>= default</c> keeps existing call sites compiling.
/// </summary>
...
public sealed class AddCancellationTokenCodeFix : CodeFixProvider
{
    ...
    public override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        // The diagnostic lands on the [Timeout] attribute; walk up to the method.
        ...
        // Skip if the method already has a CancellationToken parameter (defensive — analyzer
