...
public partial class DtoGenerator
{
    ...
    private static string GenerateCrudTestSource(CrudTestInfo info)
    {
        ...
        sb.AppendLine($"namespace {ns};");
        sb.AppendLine();
        sb.AppendLine($"/// <summary>Auto-generated CRUD integration test stubs for <c>{entity}</c>.</summary>");
        ...
        if ((info.Operations & OpCreate) != 0)
        {
            ...
            sb.AppendLine("    {");
            sb.AppendLine($"        // TODO: fill in valid Create{entity}Request properties");
            sb.AppendLine($"        var response = await _client.PostAsJsonAsync(\"/{route}\", new {{ }});");
            ...
            (info.Operations & OpUpdate) != 0 && (info.Operations & OpDelete) != 0)
        {
            ...
            sb.AppendLine($"        // TODO: fill in valid Create{entity}Request properties");
            sb.AppendLine($"        var createResponse = await _client.PostAsJsonAsync(\"/{route}\", new {{ }});");
            ...
            sb.AppendLine("        Assert.NotNull(location);");
            sb.AppendLine();
            sb.AppendLine($"        // 2. Read back");
            ...
            sb.AppendLine($"        // TODO: fill in Update{entity}Request properties");
            sb.AppendLine($"        var patchContent = new StringContent(\"{{}}\", System.Text.Encoding.UTF8, \"application/json\");");
            ...
            sb.AppendLine();
            sb.AppendLine($"        // 5. Verify deleted");
