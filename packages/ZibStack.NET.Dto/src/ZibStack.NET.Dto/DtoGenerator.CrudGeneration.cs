...
public partial class DtoGenerator
{
    ...
    private static string GenerateCodeMap(CrudApiInfo info)
    {
        ...
        sb.AppendLine($"/// Generated code map for <c>{entity}</c>:");
        sb.AppendLine("/// <list type=\"bullet\">");
        if (info.CreateRequestName != null)
            sb.AppendLine($"/// <item><description>Create DTO: <see cref=\"{info.CreateRequestName}\"/> — ToEntity(), Validate()</description></item>");
        if (info.UpdateRequestName != null)
            sb.AppendLine($"/// <item><description>Update DTO: <see cref=\"{info.UpdateRequestName}\"/> — ApplyTo(), Validate()</description></item>");
        if (info.ResponseName != null)
            sb.AppendLine($"/// <item><description>Response: <see cref=\"{info.ResponseName}\"/> — FromEntity(), ProjectFrom()</description></item>");
        if (info.ListResponseName != null)
            sb.AppendLine($"/// <item><description>List item: <see cref=\"{info.ListResponseName}\"/> — ProjectFrom()</description></item>");
        if (info.QueryName != null)
            sb.AppendLine($"/// <item><description>Query: <see cref=\"{info.QueryName}\"/> — ApplyFilter(), ApplySort(), Apply()</description></item>");
        sb.AppendLine($"/// <item><description>Endpoints: <see cref=\"{entity}Endpoints\"/> — Map{entity}Endpoints()</description></item>");
        sb.AppendLine("/// </list>");
        sb.AppendLine("/// </summary>");
