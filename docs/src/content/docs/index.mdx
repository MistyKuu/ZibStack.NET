...
hero:
  ...
  actions:
    ...
    - text: Live Playground
      link: https://zibstack-playground-808858943057.europe-central2.run.app/index.html
      icon: rocket
    - text: View on GitHub
...
<CardGrid>
	<Card title="Core" icon="puzzle">
		Shared attributes: relationships (`[OneToMany]`, `[OneToOne]`, `[Entity]`) and TypeScript-style utility types (`[PartialFrom]`, `[PickFrom]`, `[OmitFrom]`) plus JS-style `[Destructurable<T>]`.
